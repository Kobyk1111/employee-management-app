...
function EmployeeAccountSettings() {
  ...
  async function handleSubmit(e) {
    ...
    // formData.append("password", loggedInEmployee.password);
    ...
    // formData.append("employeeID", loggedInEmployee.employeeID);
    // formData.append("companyId", loggedInEmployee.companyId);
    // formData.append("companyName", loggedInEmployee.companyName);
    // formData.append("jobTitle", loggedInEmployee.jobTitle);
    // formData.append("employmentType", loggedInEmployee.employmentType);
    // formData.append("employmentStatus", loggedInEmployee.employmentStatus);
    ...
    // formData.append("dateOfBirth", loggedInEmployee.dateOfBirth);
    // formData.append("dateOfJoining", loggedInEmployee.dateOfJoining);
    ...
    // formData.append("department", loggedInEmployee.department);
    // formData.append("salary", loggedInEmployee.salary);
